                    ...
                    <div class="col-lg-6">
                        <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                ...
                                <h2 class="site-title">
                                    Sistem Pendidikan Kami <span>Memberi Inspirasi Lebih untuk Anda.</span>
                                </h2>
                            </div>
                            <p class="about-text">
                            ...
                            <div class="about-bottom">
                                <a href="index.html" class="theme-btn">Discover More<i
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
                            ...
                            <p>Halo! Temukan informasi lengkap tentang dosen-dosen kami yang berpengalaman dan
                                 berdedikasi dalam membimbing mahasiswa menuju keunggulan di bidang Teknologi Informasi."</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="#">Goklas Henry Agus Panjaitan
                                    </a></h5>
                                    <span>, M.T. (S2 ITB, Bandung)</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="#">Tegar Arifin Prasetyo</a></h5>
                                    <span>, S.Si., M.Si (S2 ITB, Bandung)
                                    </span>
                                </div>
                            </div>
                            <span class="team-social-btn"><i class="far fa-share-nodes"></i></span>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="#"> Hernawati Susanti Samosir</a></h5>
                                    <span>, SST., M.Kom (S2 ITS,
                                        Surabaya)
                                       </span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="#">Rudy Chandra</a></h5>
                                    <span>., M.Kom (S2 USU, Medan)
                                    </span>
                                </div>
                            </div>
                            <span class="team-social-btn"><i class="far fa-share-nodes"></i></span>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="#">Tiurma Lumban Gaol</a></h5>
                                    <span>, SP., M.P (S2 IPB, Bogor)
                                    </span>
                                </div>
                            </div>
                            <span class="team-social-btn"><i class="far fa-share-nodes"></i></span>
